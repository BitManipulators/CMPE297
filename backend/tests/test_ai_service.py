...
class TestAIServiceInitialization:
    ...
    def test_init_with_rag_service(self, mocker, mock_gemini):
        ...
        assert service.rag_service.is_available()
...
class TestImageAnalysis:
    ...
    async def test_analyze_plant_image_different_mime_types(self, mocker, mock_gemini):
        ...
        # Test JPEG
        response_jpeg = await service.analyze_plant_image(
            image_data=image_data,
            image_mime_type="image/jpeg"
        )
        ...
        # Test PNG
        response_png = await service.analyze_plant_image(
            image_data=image_data,
            image_mime_type="image/png"
        )
...
class TestContextHandling:
    ...
    async def test_system_prompt_inclusion(self, mocker, mock_gemini):
        ...
        # Just verify generate_content was called (system prompt is internal to AIService)
